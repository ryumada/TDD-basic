...
describe('A FigureCalculator', () => {
  ...
  describe('A calculateRectanglePerimeter function', () => {
    ...
    it('should throw error when not given with non-number parameters', () => {
      const figureCalculator = new FigureCalculator({})
      ...
      expect(() => figureCalculator.calculateRectanglePerimeter([], {})).toThrowError()
      expect(() => figureCalculator.calculateRectanglePerimeter(1, '3')).toThrowError()
      expect(() => figureCalculator.calculateRectanglePerimeter('3', 1)).toThrowError()
    })
  ...
  describe('A calculateRectangleArea function', () => {
    ...
    it('should throw error when not given with non-number parameters', () => {
      ...
      expect(() => figureCalculator.calculateRectangleArea(1, false)).toThrowError()
  ...
  describe('A calculateTrianglePerimeter function', () => {
    ...
    it('should return correct value based on triangle perimeter formula', () => {
      ...
      // Assert
      expect(result).toEqual(6) // sideA + sideB + sideC
      expect(spyAdd).toHaveBeenCalledWith(sideA, sideB)
      expect(spyAdd).toHaveBeenCalledWith(sideC, 3) // 3 * (sideA + sideB)
    })
  })
  ...
  describe('A calculateTriangleArea function', () => {
    ...
    it('should return correct value based on triangle area formula', () => {
      ...
      expect(spyDivide).toHaveBeenCalledWith(20, 2) // ((base * height), 2)
    })
  })
})
